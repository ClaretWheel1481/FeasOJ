...
export const uploadCode = async (file, pid, username, token) => {
    ...
    return await axios.post(`${apiUrl}users/${username}/code`, formData, {
        params: {
            'problem': pid
        },
        headers: {
...
export const updateSynopsis = async (username, token, synopsis) => {
    ...
    return await axios.put(`${apiUrl}users/${username}/synopsis`, formData, {
        headers: {
            Authorization: token,
        }
    })
...
export const uploadAvatar = async (file, username, token) => {
    ...
    return await axios.put(`${apiUrl}users/${username}/avatar`, formData, {
        headers: {
            'Content-Type': 'multipart/form-data',
            Authorization: token
        },
